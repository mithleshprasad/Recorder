...
//         <Container>
//           <Navbar.Brand href="#home">Screen Recorder</Navbar.Brand>
//         </Container>
//       </Navbar>
//       <Container className="mt-5 sss">
//         <div className="text-center mb-4">
//           <h1>Screen Recorder</h1>
//           <p>Click the button below to start recording your screen.</p>
//         </div>
//         <Button
...
//         <span>Screen Recorder App &copy; {new Date().getFullYear()} - Created by Mithlesh Maurya</span>
//         </div>
//       </footer>
//     </div>
//   );
